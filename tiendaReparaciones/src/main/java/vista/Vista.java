...
public class Vista extends JFrame {
	...
	private JMenuItem mntmNewMenuItemSalir,mntmNewMenuItemNuevoTecnico,mntmNewMenuItemListarTecnicos,
	mntmNewMenuItemEliminarTecnico,mntmNewMenuItemNuevoOrdenador,mntmNewMenuItemListarOrdenadores,
	mntmNewMenuItemActualizarOrdenador, mntmNewMenuItemNuevaReparacion,mntmNewMenuItemListarReparaciones,musica;
	
	private JTextField textFieldNuevoTecnicoNombre,textFieldIdEliminarTecnico,textFieldNuevoTecnicoID,
	textFieldNuevoOrdenadorID,textFieldNuevoOrdenadorNombre,textFieldActualizarOrdenadorID,textFieldActualizarOrdenadorNombre,
	textFieldNuevaReparacionIDTecnico,textFieldNuevaReparacionIDOrdenador,textFieldNuevaReparacionNumHoras;
	private JTextField textFieldNuevaReparacionCoste;
	
	private JButton btnNewButtonAltaTecnico, btnNewButtonNuevaReparacionAlta,btnNewButtonEliminarTecnico,
	btnNewButtonActualizarOrdenador,btnNewButtonNuevoOrdenadorAlta,btnNewButtonOrdenadorCargar;

	private JLabel lblNewLabelAvisoTecnico, lblNewLabel,lblNewLabelAvisoEliminarTecnico,lblNewLabelAvisoMostrarTecnicos,
	lblNewLabelNuevoOrdenadorAviso,lblNewLabelAvisoModificarOrdenador,lblNewLabelListarOrdendores,lblNewLabelAvisoNuevaReparacion,
	lblNewLabelAvisoListarReparaciones;

	private JCheckBox chckbxNewCheckBoxModificarOrdenadorArreglado,chckbxNewCheckBoxNuevoOrdenadorArreglado;
	
	private JTextArea textAreaListarOrdenadores, textAreaModificarOrdenadorDescripcion,textAreaNuevoOrdenadorDescripcion,textArea,
	textAreaListarReparaciones;
		  ...
		  setResizable(false);
	        ...
	        contentPane = new JPanel() {
	            ...
	            protected void paintComponent(Graphics g) {
	                ...
	                URL imageUrl = getClass().getClassLoader().getResource("images/fondo.png");
	                if (imageUrl != null) {
